 ...
 * public/craftbase_favicon_espresso.svg so it stays pixel-identical to the
 * real favicon; only color, and the stroke/glyph animation classes, differ.
 */
            ...
            >
                <g transform="matrix(1 0 0 1 2047 1263)">
                    ...
                    <g transform="matrix(1 0 0 1 -39 43)">
                        <path
                            className="cb-mark-stroke cb-mark-s2"
                    ...
                    <g transform="matrix(1 0 0 1 -16 5)">
                        {/* The CSS scale animation on .cb-mark-glyph would override
                            an SVG `transform` attribute on the same element (CSS
                            transform wins over the presentation attribute rather
                            than composing with it), so the 19.53 position offset
                            lives on this wrapping <g> instead of on the path. */}
                        <g transform="matrix(1 0 0 1 0 19.53)">
                            <path
                                className="cb-mark-glyph"
                    ...
                    <g transform="matrix(1 0 0 1 -35 -34)">
                        <path
                            className="cb-mark-stroke cb-mark-s3"
                            d="M 2.337712 2.934926 L 78.134741 2.934926 "
                            fill="none"
                            strokeWidth={15.419922024441979}
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            strokeMiterlimit={4}
                            pathLength={1}
                    ...
                    <g transform="matrix(1 0 0 1 42 -30)">
                        <path
                            className="cb-mark-stroke cb-mark-s4"
                    ...
                    <g transform="matrix(1 0 0 1 46 12)">
                        <path
                            className="cb-mark-stroke cb-mark-s5"
